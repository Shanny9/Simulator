...
<body>
					...
					<div class="col-sm-6 col-sm-offset-3 form-box">
						<div class="form-top">
							<div class="form-top-left">
								...
								<p>Select a course name to download incident flow file</p>
							</div>
						...
						<div class="form-bottom">
							<form role="form"  action="DownloadServlet"
								...
								<button type="submit" class="btn disabled" id="start">Download</button>
							</form>
	...
	<script src="js/selectCourse_file.js"></script>
